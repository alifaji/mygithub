...
class C_reportsales extends CI_Controller {
	...
	public function index($nama)
	{
		...
		$data['data_salescustom'] = $this->m_campaign->getJoinSales(str_replace("%20", " ", $nama));
		$this->load->view('Admin/report_custom',$data); 
	}
	/*
