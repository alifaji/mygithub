                                ...
                                <tbody>
                                    ...
                                    //if($id_k->id==3){
                                        ...
                                        <tr>
                                            ...
                                            <td><center><?php echo $id_p->produk_nama; ?></center></td>
                                            <td><center><?php echo $id_p->produk_category; ?></center></td>
                                            <td><center><?php echo $id_p->produk_harga; ?></center></td>
                                            <td><center>
                                                <a href="#" onclick="edit_product(<?php echo $id_p->produk_id; ?>)" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#modal-edit">
                                                    <i class="fa fa-edit"></i> Edit</a>&nbsp
                                                    <a href="<?php echo site_url('Admin/Master/Data/C_product/deleteProduct/'.$id_p->produk_id) ?>" class="btn btn-xs btn-danger " onclick="return confirm('Apakah kamu yakin ingin menghapus data ini?')"><i class="glyphicon glyphicon-remove"></i> Delete</a> </center></td>
                                                </tr>
                                                <?php 
                                            //}
                                        //else{
                            ...
                            <form id="login-form" action ="<?php echo site_url("Admin/Master/Data/C_product/editProduct");?>" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <select class="form-control" name="category_nama" placeholder="Pilih Category" id="category_nama" required>
                                            <option value="" disabled selected>Select Category :</option>
                                            <?php 
                                            foreach ($data_category as $row_data) {
                                                ?>
                                                <option value="<?php echo $row_data->category_nama;?>">
                                                    <?php echo $row_data->category_nama; ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                        ...
                        <div id="div-forms">
                            ...
                            <form id="login-form" action ="<?php echo site_url("Admin/Master/Data/C_product/insertProduct");?>" method="post">
                                <div class="modal-body">
                                    <div class="form-group has-feedback">
                                        <label>Category : </label>
                                        <select class="form-control" name="category_nama" placeholder="Pilih Category" required>
                                            <option value="" disabled selected>Select Category :</option>
                                            <?php 
                                            foreach ($data_category as $row_data) {
                                                ?>
            ...
            <script>
                function edit_product(id) {
                    $.ajax({
                        ...
                        $("#id_product").val(hasil.produk_id);
                        $('option[value="' + hasil.produk_category + '"]')
                        .attr('selected', true);
                        $("#nama_product").val(hasil.produk_nama);
                        $("#harga_product").val(hasil.produk_harga);
