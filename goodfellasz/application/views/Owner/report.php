...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-sort-amount-desc "></i> Report Graphic </a></li>
				...
				<div class="box-body" style="overflow-x: auto">
					<div class="box box-success">
						<div class="box-header with-border">
							<h3 class="box-title"><center>Sisa Campaign VS Closing</center></h3>
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	...
	<div class="modal fade" id="modal-input" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		...
		<?php
		foreach ($data_sisa as $sisa) {
			$camp[]= "'$sisa->sisa_campaign'";
		}
		foreach ($data_close as $close) {
			$closed[]= "'$close->sisa_closing'";
		} 
		foreach ($data_sales as $key) {
			$nama[]= "'$key->sales_nama'";
		}
		$tampung = implode(",", $nama); 
		$tampungcamp = implode(",", $camp);
		$tampungclose = implode(",", $closed);
		?>
