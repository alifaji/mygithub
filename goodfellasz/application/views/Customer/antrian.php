                ...
                if($id_c->barberman_ready == "Yes"){ 
                    ...
                    <div class="col-lg-4 col-xs-12">
                      ...
                      <div class="small-box bg-aqua">
                        ...
                        <a href="#" onclick="tambah_data(<?php echo $id_c->barberman_kursi; ?>)" class="small-box-footer" data-toggle="modal" data-target="#modal-input">Add Queue <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                <?php } 
                else {
                    ?>
                            ...
                            <tbody>
                                ...
                                foreach ($antrian as $val) {
                                    if($id_c->barberman_kursi == $val->antrian_kursi && $id_c->barberman_cabang == $val->antrian_cabang){
                                        ...
                                        <tr>
                                          <td> <?php echo $no++ ?></td>
                                          <td> <?php echo $val->antrian_pelanggan ?></td>
        ...
        <div class="modal-content">
            ...
            <div id="div-forms">
                ...
                <form id="login-form" action ="<?php echo site_url("Admin/C_antrian/insert_antrian");?>" method="post">
                    <div class="modal-body">
                        <div class="form-group has-feedback">
                            <input type="hidden" class="form-control" id="no_kursi" placeholder="" name="no_kursi" readonly >
                        </div>
                        <div class="form-group has-feedback">
                            <label>Nama User :</label>
                            <input class="form-control" placeholder="Nama User" type="text" name="nama_user" required="">
                        </div>
                        <div class="form-group has-feedback">
                            <label>Time : </label>
                            <small>Ex :10:00 AM / 10:00 PM</small>
    ...
    function edit_antrian(id){
        $.ajax({
           ...
           success: function(data) {
              ...
              $("#modal-edit #nama_user").val(hasil.antrian_pelanggan);
