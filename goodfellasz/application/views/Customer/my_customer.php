...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-database"></i> Data Customer </a></li>
						...
						<div class="box-body" style="overflow-x: auto">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
									$no=0;
									foreach ($data_join as $id_j) { 
                                        //$no++;
                                    //if($id_k->id==3){
                                    	// if($id_j->campaign_sales == $this->session->userdata("sales")){
										?>
										<tr>
											<td><?php echo $no += 1?></td>
											<td><?php echo $id_j->customer_nama; ?></td>
											<td><?php echo $id_j->customer_alamat; ?></td>
											<td><?php echo $id_j->customer_email; ?></td>
											<td><?php echo $id_j->customer_telp; ?></td>
											<td>
												<center>
												<a href="#" onclick="detail_customer(<?php echo $id_j->customer_id; ?>)" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modal-edit">
													<i class="fa fa-edit"></i> Detail Customer</a>
													</center>
												</td>
											</tr>
											<?php 
							...
							<form id="login-form" action ="<?php echo site_url("Admin/Master/Data/C_customer/editCustomer");?>" method="post">
								<div class="modal-body">
									...
									<div class="form-group has-feedback">
										<label>Name</label>
										<input class="form-control" placeholder="Nama Lengkap" type="text" name="nama_customer" id="nama_customer" readonly>
									</div>
									<div class="form-group has-feedback">
										<label>Address</label>
										<textarea class="form-control" placeholder="alamat lengkap" required="" name="alamat_customer" id="alamat_customer" readonly></textarea>
									</div>
									<div class="form-group has-feedback">
										<label>E-Mail</label>
										<input class="form-control" placeholder="email" type="email" name="email_customer" id="email_customer" readonly="">
									</div>
									<div class="form-group has-feedback">
										<label>Telephone</label>
										<input class="form-control" placeholder="telpon" type="text" name="telp_customer" id="telp_customer" readonly>
									</div>
								<!--
								<div class="form-group has-feedback">
									<label>Sales :</label>
	...
	<div class="modal fade" id="modal-input" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
					...
					<div id="div-forms">
						...
						<form id="login-form" action ="<?php echo site_url("Admin/Master/Data/C_customer/insertCustomer");?>" method="post">
							<div class="modal-body">
								<div class="form-group has-feedback">
									<label>Nama</label>
									<input class="form-control" placeholder="Nama Lengkap" type="text" name="nama_customer">
								</div>
								<div class="form-group has-feedback">
									<label>Alamat</label>
								...
								<div class="form-group has-feedback">
									<label>Email</label>
									<input class="form-control" placeholder="email" type="email" name="email_customer">
								</div>
								<div class="form-group has-feedback">
									<label>Telpeon</label>
									<input class="form-control" placeholder="telpon" type="text" name="telp_customer">
								</div>
									<!--
									<div class="form-group has-feedback">
										<label>Sales :</label>
		...
		<script>
			function detail_customer(id) {
				$.ajax({
					url: "<?php echo base_url("Sales/C_mycustommer/detailCustomer/")?>"+id,
					type: "POST",
