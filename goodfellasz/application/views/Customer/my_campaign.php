		...
		<div class="row">
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								...
								foreach ($data_campaign as $id_c) { 
                                        //$no++;
									if($id_c->campaign_status != "Close" && $id_c->campaign_sales == $this->session->userdata("sales")){
										?>
										<tr>
											<td><center><?php echo $no += 1?></center></td>
											<td>
												<center>
													<a href="<?php echo site_url('Sales/C_myhistory/index/'.$id_c->campaign_id) ?>">
					...
					<div class="modal-content">
						<div class="modal-header" align="center">
							...
							<div id="div-forms">
								...
								<!-- Begin # Login Form -->
								<form id="login-form" action ="<?php echo site_url("Sales/C_mycampaign/editCampaign");?>" method="post">
									<div class="modal-body">
										...
										<div class="row">
											<div class="col-md-6">
												...
												<!-- <select class="form-control" name="customer_nama" id="customer_nama" placeholder="Pilih Customer" required readonly value="" disabled="">
											...
											<div class="col-md-6">
												<div class="form-group has-feedback">
													...
													<!-- <select class="form-control" name="sales_nama" id="sales_nama" placeholder="Pilih Sales" required>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group has-feedback">
													<label>Product : </label>
													<select class="form-control" name="product_nama" id="product_nama" placeholder="Pilih Product" required>
									...
									<form id="login-form" action ="<?php echo site_url("Admin/C_campaign/insertCampaign");?>" method="post">
										<div class="modal-body">
											<div class="form-group has-feedback">
												...
												<select class="form-control" name="customer_nama" placeholder="Pilih Customer" required>
													<option value="" disabled selected>Pilih Customer :</option>
													<?php 
													foreach ($data_customer as $row_customer) {
														?>
											...
											<div class="form-group has-feedback">
												<label>Sales : </label>
												<select class="form-control" name="sales_nama" placeholder="Pilih Sales" required>
													<option value="" disabled selected>Pilih Sales :</option>
													<?php 
													foreach ($data_sales as $row_sales) {
														?>
											...
											<div class="form-group has-feedback">
												<label>Product : </label>
												<select class="form-control" name="product_nama" placeholder="Pilih Product" required>
											...
											<div class="form-group has-feedback">
												<label>Tanggal</label>
												<input class="form-control" placeholder="" type="date" name="date_campaign">
											</div>
										<!--
			...
			<script>
				function proses_campaign(id) {
					$.ajax({
						url: "<?php echo base_url("Sales/C_mycampaign/detailCampaign/")?>"+id,
						type: "POST",
