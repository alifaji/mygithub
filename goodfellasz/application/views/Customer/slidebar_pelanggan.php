...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      -->
      <li class="">
        <a href="<?php echo base_url("movement/showAntrianPelanggan");?>">
      ...
      <li class="">
        <a href="<?php echo base_url("movement/myClosing");?>">
          <i class="fa fa-male"></i> <span>Hairstyle</span>
          <span class="pull-right-container">
            <i class=""></i>
          </span>
        </a>
      ...
      <li class="">
        <a href="<?php echo base_url("Customer/C_mypoint/index");?>">
          <i class="fa fa-money"></i> <span>My Point</span>
          <span class="pull-right-container">
            <i class=""></i>
          </span>
        </a>
      ...
      <li class="">
        <a href="<?php echo base_url("Customer/C_myhistory/index");?>">
...
<?php 
} else if($this->session->userdata('status')=="login_customer"){
