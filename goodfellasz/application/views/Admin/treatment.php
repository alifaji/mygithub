...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Data Trearment</li>
        </ol>
    </section>
                            ...
                            <div class="col-lg-2 col-xs-6">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#modal-input">
                                        <i class="fa fa-plus"></i> Add Treatment</button>
                                    </div>
                                </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead style="background-color: #81CFE0">
                                    <tr>
                                        ...
                                        <th><center>Treatment Name</center></th>
                                ...
                                <tbody>
                                    ...
                                    //if($id_k->id==3){
                                        ...
                                        <tr>
                                            ...
                                            <td><center><?php echo $id_p->treatment_nama; ?></center></td>
                                            <td><center><?php echo $id_p->treatment_harga; ?></center></td>
                                            <td><center>
                                                <a href="#" onclick="edit_treatment(<?php echo $id_p->id_treatment; ?>)" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#modal-edit">
                                                    <i class="fa fa-edit"></i> Edit</a>&nbsp
                                                    <a href="<?php echo site_url('Admin/Master/Data/C_treatment/deleteTreatment/'.$id_p->id_treatment) ?>" class="btn btn-xs btn-danger " onclick="return confirm('Apakah kamu yakin ingin menghapus data ini?')"><i class="glyphicon glyphicon-remove"></i> Delete</a> </center></td>
                                                </tr>
                                                <?php 
                                            //}
                                        //else{
