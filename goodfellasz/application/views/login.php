      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label> 
              <a href="#" data-toggle="modal" data-target="#modal-recovery">Forget Password </a>
            </label>
            <label> 
              <a href="<?php echo site_url("C_registrasi/index")?>">Register New Member </a>
            </label>
          </div>
        </div>
        <!-- /.col -->
            ...
            <div class="modal-content">
              <div class="modal-header" align="center">
                ...
                <div id="div-forms">
                  ...
                  <!-- Begin # Login Form -->
                  <form id="login-form" action ="<?php echo site_url("C_login/lupa_password");?>" method="post">
                ...
                <div class="form-group has-feedback">
                  ...
                  <input class="form-control" placeholder="Nomor Ponsel" type="text" name="telp" required="">
                </div>
                <div class="form-group has-feedback">
                  <label>E-Mail</label>
